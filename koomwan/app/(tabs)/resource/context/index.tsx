...
import { articleBoxProps } from "../components/ArticleBox";
    ...
    <SafeAreaView className="flex-1">
      <ScrollView>
        <Card>
          ...
          <Text className="font-san text-description text-secondary">{mockTextContent}</Text>
        </Card>
      </ScrollView>
    </SafeAreaView>
  );
...
export default function ArticleContent() {
  const mockData : articleBoxProps = 
    {
